...
{
public:
  SC_KEYNODES_BODY(CoreKeynodes)

  static ScKeynodeClass const question;
  static ScKeynodeClass const question_initiated;
  static ScKeynodeClass const question_finished;
  static ScKeynodeClass const question_finished_successfully;
  static ScKeynodeClass const question_finished_unsuccessfully;
