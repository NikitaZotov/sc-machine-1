...
sc_addr test_generate_elements_and_call_agent_search_full_semantic_neighborhood(
    ...
    sc_addr const addr)
{
  sc_addr const idtf_addr = sc_memory_node_new(context, sc_type_const_node_link);  // idtf_addr = {}
  sc_addr const idtf_edge_addr =
      sc_memory_arc_new(context, sc_type_const_common_arc, idtf_addr, addr);  // addr => idtf_addr
  sc_memory_arc_new(
      context,
  ...
  sc_addr const translation_edge_addr =
      sc_memory_arc_new(context, sc_type_const_common_arc, translation_addr, addr);  // translation => addr
  sc_memory_arc_new(
      context,
      sc_type_const_perm_pos_arc,
  ...
  sc_addr const link_addr = sc_memory_node_new(context, sc_type_const_node_link);       // link
  ...
  sc_addr const norole_addr =
      sc_memory_node_new(context, sc_type_node | sc_type_const | sc_type_node_non_role);  // norole
