...
{
  EXPECT_EQ(sc_fs_memory_initialize(SC_FS_MEMORY_PATH, SC_FALSE, &fs_memory_manager), SC_FS_MEMORY_OK);
  EXPECT_EQ(sc_fs_memory_shutdown(fs_memory_manager), SC_FS_MEMORY_OK);
...
{
  EXPECT_EQ(sc_fs_memory_initialize("", SC_FALSE, &fs_memory_manager), SC_FS_MEMORY_NO);
  EXPECT_EQ(sc_fs_memory_shutdown(fs_memory_manager), SC_FS_MEMORY_NO);
...
{
  EXPECT_EQ(sc_fs_memory_initialize(SC_FS_MEMORY_PATH, SC_TRUE, &fs_memory_manager), SC_FS_MEMORY_OK);
  EXPECT_EQ(sc_fs_memory_shutdown(fs_memory_manager), SC_FS_MEMORY_OK);
...
TEST(ScFSMemoryTest, sc_fs_memory_save_load)
{
  ...
  EXPECT_EQ(sc_fs_memory_load(storage, fs_memory_manager), SC_FS_MEMORY_OK);
  ...
  EXPECT_EQ(sc_fs_memory_save(storage, fs_memory_manager), SC_FS_MEMORY_OK);
...
TEST(ScFSMemoryTest, sc_fs_memory_save_load_deprecated_segments)
{
  ...
  EXPECT_EQ(
      sc_fs_memory_initialize(SC_DEPRECATED_DICTIONARY_FS_MEMORY_PATH, SC_FALSE, &fs_memory_manager), SC_FS_MEMORY_OK);
...
TEST(ScFSMemoryTest, sc_fs_memory_save_load_save_invalid_file_read)
{
  ...
  EXPECT_EQ(sc_fs_memory_load(storage, fs_memory_manager), SC_FS_MEMORY_READ_ERROR);
...
TEST(ScFSMemoryTest, sc_fs_memory_save_load_save_invalid_file_write)
{
  ...
  EXPECT_EQ(sc_fs_memory_save(storage, fs_memory_manager), SC_FS_MEMORY_WRITE_ERROR);
  EXPECT_EQ(sc_fs_memory_load(storage, fs_memory_manager), SC_FS_MEMORY_OK);
